necesito que ejecutes una tarea específica de refactorización basándote en las instrucciones detalladas que he guardado en este archivo: ai\promps\refactoring\4-2.md

Inmeidatamente despues ejecuta este skill: ai\skills\global\global_criticador.md

Por favor, sigue estos pasos:
1. Lee el contenido del archivo `4-2.md` indicado.
